...
> Discord server backup bot, channels roles members export 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

💾 &nbsp;**Full backup** — channels, roles, members, settings

📎 &nbsp;**Emoji backup** — save all server emojis

☁️ &nbsp;**Cloud save** — encrypted backup stored securely

🔄 &nbsp;**Auto-backup** — daily or weekly scheduled backups

♻️ &nbsp;**Restore** — restore from backup in one command

📊 &nbsp;**Backup history** — multiple backup snapshots
